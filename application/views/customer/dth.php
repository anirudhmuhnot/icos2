...
<div class="container">
<center>
<form class="contact-form" method="post" action="<? echo base_url()."index.php/customer/add_plan_dth"; ?>">
    <select name='number'>
        <option value=' ' disabled selected>Choose your number</option>
        <? $sname='dth';  $res = $this->customer_model->check_multiple($sname);
            foreach ($res as $obj) {
                echo "<option style='color:teal;' value='".$obj->subscriber_id."'>".$obj->subscriber_id."</option>";  
            }
                ...
                <div class="card-content">
                    <div class="col s12 m6">
                        ...
                        <table class="bordered highlight centered responsive-table">
                            ...
                            <tbody>
                                <? $res = $this->customer_model->return_all_plans_dth();
                                    foreach ($res as $obj) {
                                        echo "<tr>";
                                        echo "<td>".$obj->plan."</td>";
