...
<div class="container">
<center>
<form class="contact-form" method="post" action="<? echo base_url()."index.php/customer/add_plan_data"; ?>">
    <select name='number'>
        <option value=' ' disabled selected>Choose your number</option>
        <? $sname='data_services';  $res = $this->customer_model->check_multiple($sname);
            foreach ($res as $obj) {
                ...
                <div class="card-content">
                    <div class="col s12 m6">
                        ...
                        <table class="bordered highlight centered responsive-table">
                            ...
                            <tbody>
                                <? $res = $this->customer_model->return_all_plans_data();
                                    foreach ($res as $obj) {
                                        echo "<tr>";
                                        echo "<td>".$obj->plan."</td>";
